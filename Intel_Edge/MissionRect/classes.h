...
public:
	...
	void Show(const char* s = NULL);	//New Current point, s:Point name
	void ShowEx(const char* s = NULL);	//New Current point, no Linefeed
...
public:
	Rect(Point pp1, Point pp2) : p1(pp1), p2(pp2),		// 생성자
